  ...
  return (
    <div className="bg-gray-50 dark:bg-[#101e38]">
      <div className="lg:w-[1200px] md:mx-auto h-full border-x border-gray-100 dark:border-gray-800 bg-white dark:bg-[#0e182c]">
        ...
        {/* Landing */}
        <div className="pb-10 pt-24 sm:pt-28 md:pt-44 flex px-6 md:px-24">
          <div className="self-center">
            ...
            <div className="flex gap-2 align-center flex-wrap md:flex-nowrap">
              <div className="lg:w-[80%] text-gray-900 dark:text-gray-100 self-center">
                ...
                <p className="mt-6 dark:text-gray-300 text-base font-light lg:w-[87%] leading-7">
        ...
        <div
          id="projects"
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 md:px-16"
        >
        ...
        <div className="flex flex-wrap lg:flex-nowrap justify-between gap-12 mt-20 md:px-16">
          ...
          <div>
            <div className="p-6 hover:bg-gray-50 transition-all duration-300 hover:dark:bg-[#101e38] md:rounded-xl">
              ...
              <p className="leading-7 mt-2 text-base font-light text-gray-500 dark:text-gray-300">
                {user_info.skills.languages.description}
              </p>
              <img
                className="w-48 mt-4"
                src={user_info.skills.languages.image + theme}
              />
            </div>
            <div className="p-6 hover:bg-gray-50 transition-all duration-300 hover:dark:bg-[#101e38] md:rounded-xl">
              <h4 className="text-lg font-medium text-gray-600 dark:text-gray-300">
              ...
              <p className="leading-7 mt-2 text-base font-light text-gray-500 dark:text-gray-300">
                {user_info.skills.frameworks.description}
              </p>
              <img
                className="w-48 mt-4"
                src={user_info.skills.frameworks.image + theme}
              />
            </div>
            <div className="p-6 hover:bg-gray-50 transition-all duration-300 hover:dark:bg-[#101e38] md:rounded-xl">
              <h4 className="text-lg font-medium text-gray-600 dark:text-gray-300">
              ...
              <p className="leading-7 mt-2 text-base font-light text-gray-500 dark:text-gray-300">
                {user_info.skills.tools.description}
              </p>
              <img
                className="w-48 mt-4"
                src={user_info.skills.tools.image + theme}
              />
            </div>
          </div>
          ...
          <div className="w-full px-2 lg:px-0 lg:w-[70%]">
            <div className="border dark:border-gray-500 p-8 rounded-xl">
              <div className="flex gap-4">
                ...
                <h4 className="text-gray-500 dark:text-gray-300 self-center">
                  Education
                </h4>
              </div>
                  ...
                  <div key={index} className="flex gap-4 mt-8">
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex justify-between">
                        <p className="text-gray-500 dark:text-gray-300 text-xs w-full">
                          {education.degree}
                        </p>
                        <p className="text-gray-500 dark:text-gray-300 text-right w-[50%] text-xs">
                          {education.year}
                        </p>
                      </div>
                    </div>
        ...
        <div id="contact" className="mt-12 pt-12 px-6 md:px-24">
          <h4 className="text-5xl font-bold text-gray-900 dark:text-gray-100">
            {user_info.contact.title}
          </h4>

          <p className="mt-8 leading-7 text-base text-gray-500 dark:text-gray-300 font-light">
        ...
        <footer className="p-4 text-center md:flex justify-between">
          ...
          <p className="text-gray-500 self-center mt-2 md:mt-0 dark:text-gray-300 text-sm text-center font-light">
            {user_info.footer}
          </p>
          <button
            onClick={() => scrollToTop()}
            className="text-gray-500 self-center mt-2 md:mt-0 dark:text-gray-300 mx-auto md:mx-0 text-sm font-light flex gap-2"
          >
